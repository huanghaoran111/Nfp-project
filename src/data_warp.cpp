...
namespace Case{
    namespace helper {
        bool testLineIntersect(std::shared_ptr<Shape> line1, std::shared_ptr<Shape> line2, Line::LineRelationship res) {
            return dynamic_cast<Line*>(line1.get())->isIntersectToLine(*dynamic_cast<Line*>(line2.get())) == res;
        }
        struct TwoLine {
            Line line1;
            Line line2;
    ...
    bool caseTemp(helper::TwoLine twoLine, Line::LineRelationship res) {
        ...
        return helper::testLineIntersect(a, b, res);
    }
...
void TestCases::apply() {
    ...
    assert(res);
    res &= caseTemp(helper::TwoLine(Point(0, 0), Point(200, 0), Point(100, -100), Point(100, 200)), Line::LineRelationship::INTERSECT);
    assert(res);
    res &= caseTemp(helper::TwoLine(Point(0, 0), Point(200, 0), Point(100, 0), Point(100, 100)), Line::LineRelationship::INTERSECT);
    assert(res);
